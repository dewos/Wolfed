...
public class OperationDialog_1 extends JDialog
{
    private WolfedEditorCopyOne editor;
     ...
     */
    public OperationDialog_1(WolfedEditorCopyOne editor, int requiredGraphs)
    {
        this.editor = editor;
