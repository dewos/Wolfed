...
public class ZeroOrMoreIteration extends Iteration
{
    public ZeroOrMoreIteration(List<PetriNetGraph> inputGraphs) throws Exception
    {
    ...
    void compose()
    {
        ...
        getOperationGraph().insertArc(null, getOperationGraph().getInitialPlaces().get(0), zeroTransition);
        getOperationGraph().insertArc(null, zeroTransition, getOperationGraph().getFinalPlaces().get(0));
    }
}
